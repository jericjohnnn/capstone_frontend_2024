      ...
      <div class="flex flex-col flex-grow">
        <div class="overflow-x-auto">
          <div class="flex flex-col w-[68rem] space-y-2">
            ...
            <div class="overflow-y-auto max-h-[445px] w-[69rem]">
              <div v-for="student in filteredStudents" :key="student.user_id" class="flex text-gray-600 justify-between py-2 w-full border-2 rounded-md bg-blue-200">
