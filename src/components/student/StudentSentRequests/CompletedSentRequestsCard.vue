        ...
        <div class="flex items-center gap-2">
          ...
          >
            ...
            <button
              ...
              class="hidden w-3/6 tablet:block py-1.5 px-3 text-xs font-medium rounded-md border border-blue-600 text-blue-600 hover:bg-blue-50 transition-colors duration-200"
            >
              View Profile
            </button>
