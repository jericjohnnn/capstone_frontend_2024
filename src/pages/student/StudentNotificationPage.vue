      ...
      <div class="container mx-auto py-8">
        <div class="flex justify-between mb-6">
          ...
          <button
            ...
            class="py-1 px-3 bg-blue-600 text-white rounded-md mb-2 disabled:opacity-50 flex items-center gap-2"
          >
            Refresh
          </button>
        </div>
        ...
        <div v-if="error" class="bg-red-50 text-red-600 p-4 rounded-lg mb-4">
          {{ error }}
          <button @click="fetchNotifications()" class="underline ml-2">
            Try again
          </button>
        </div>
